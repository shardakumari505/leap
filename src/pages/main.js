    ...
    return (
        <>
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "10px", marginBottom: "12px" }}>
                ...
                <span className='text-4xl font-bold'>Learn about the program, fees, jobs & more</span>
            </div>
            <Tabs defaultValue={1}>
                ...
                <TabPanel className="w-full font-sans text-sm mt-8" value={1} style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap" }}>
                    ...
                    <div style={{ position: 'relative', marginTop: '5vh' }}>
                        ...
                        />
                        <div className='h-32 z-10 width-inherit flex justify-center' style={{ position: 'absolute', bottom: '-80px', left: 0, right: 0, alignItems: "center", borderRadius: "12px", background: 'linear-gradient(96.94deg, #F3EDFF 34.36%, rgba(255, 217, 190, 0.21) 95.05%)', backdropFilter: "blur(10px)", }} >
